...
Khi người dùng yêu cầu sinh Use Case (hoặc sử dụng lệnh `/usecase`), bạn BẮT BUỘC phải tạo ra ít nhất **10 đến 14 use case chi tiết** bao phủ toàn bộ các nhóm sau (KHÔNG ĐƯỢC THIẾU các usecase nghiệp vụ cốt lõi):
